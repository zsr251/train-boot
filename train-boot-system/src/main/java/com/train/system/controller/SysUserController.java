...
import com.train.system.vo.SysUserPasswordVO;
...
public class SysUserController {
    ...
    public Result<String> password(@RequestBody @Valid SysUserPasswordVO vo) {
        ...
        redisCache.delete(RedisConstant.LOGIN_ERR_ + user.getUsername());
        redisCache.delete(RedisConstant.LOGIN_LOCK_ + user.getUsername());
        return Result.ok();
    }
    ...
    public Result<String> update(@RequestBody @Valid SysUserVO vo) {
        ...
        redisCache.delete(RedisConstant.LOGIN_ERR_ + vo.getUsername());
        redisCache.delete(RedisConstant.LOGIN_LOCK_ + vo.getUsername());
        return Result.ok();
    }
